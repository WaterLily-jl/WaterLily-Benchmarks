...
> **_NOTE:_** For Windows users: Use `git-bash` to run the benchmarks. Run `git-bach` or open Git Bash from the Windows search bar and then you can follow the other instructions in this readme.
